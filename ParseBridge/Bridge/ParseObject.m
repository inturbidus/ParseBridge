...
+ (void)initializeJava
{
    ...
    [ParseObject registerStaticMethod:@"saveAll"
                             selector:@selector(saveAll:error:)
                          returnValue:nil
                            arguments:[JavaList className], nil];
    ...
    [ParseObject registerInstanceMethod:@"objectId" selector:@selector(objectId)
                            returnValue:[NSString className]
                              arguments:nil];

    [ParseObject registerInstanceMethod:@"delete" selector:@selector(delete:)
                            returnValue:nil
...
/*-
 ...
 - (NSString*)objectId;
 - (void)saveAll:(NSArray*) error:(NSError*)error;
 - (ParseACL*)ACL
*/

- (void)setObject:(id)value forKey:(NSString*)key
{
    [self forKey:key setObject:value];
}
